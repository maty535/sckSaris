...
| [- Informáčný leták o zraze]({{ '/assets/docs/2026-06-18-zraz-sigord.pdf' | relative_url }})  | <img alt="image" width="150" height="180"  src="{{ '/assets/img/zraz-2026-qr-code.png' | relative_url }}" alt="QR kód zrazu" />  :|| 

 <img alt="image" src="{{ '/assets/img/plagat-zrazu.jpg' | relative_url }}" alt="QR kód zrazu" /> 
